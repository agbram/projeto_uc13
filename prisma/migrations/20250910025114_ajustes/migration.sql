...
INSERT INTO "new_purchases" ("created_at", "id", "is_finished", "is_shipped", "order_id", "purchase_payment_form", "purchase_price", "purchased_products", "purchased_quantity", "updated_at", "user_id") SELECT "created_at", "id", "is_finished", "is_shipped", "order_id", "purchase_payment_form", "purchase_price", "purchased_products", "purchased_quantity", "updated_at", "user_id" FROM "purchases";
